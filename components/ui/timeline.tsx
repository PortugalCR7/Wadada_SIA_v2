        ...
        >
          ...
          >
            <div className="sticky top-20">
              <div className="relative overflow-hidden rounded-2xl aspect-[3/4] bg-gray-100 group/image cursor-pointer">
                <img
                  src={entry.image || "/placeholder.svg"}
                  alt={entry.alt}
                  className="w-full h-full object-cover transition-transform duration-700 group-hover/image:scale-105"
                />
                <div className="absolute inset-0 bg-black/10 group-hover/image:bg-black/60 transition-all duration-500" />
                <div className="absolute inset-0 flex items-end p-8 md:p-10">
                  <div className="translate-y-6 opacity-0 group-hover/image:translate-y-0 group-hover/image:opacity-100 transition-all duration-500">
                    <p className="text-white/60 text-xs uppercase tracking-[0.3em] font-black mb-3">{entry.alt}</p>
                    <p className="text-white text-lg md:text-xl leading-relaxed" style={{ fontFamily: 'var(--font-cormorant)', fontStyle: 'italic', fontWeight: 300 }}>{entry.description}</p>
                  </div>
                </div>
              </div>
            </div>
