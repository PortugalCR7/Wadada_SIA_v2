  ...
  return (
    <div className="space-y-8">
      ...
      <form action={save} className="space-y-6">
        <div>
          <label className="block text-xs uppercase tracking-widest text-zinc-400 mb-2">Body Copy</label>
          <textarea name="body_copy" defaultValue={footer?.body_copy ?? ""} rows={4} className="w-full bg-zinc-900 border border-zinc-700 text-white px-4 py-3 focus:outline-none focus:border-white" />
        </div>
        <div>
